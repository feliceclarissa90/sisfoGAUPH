<div class="form-group {{ $errors->has('user_role_id') ? 'has-error' : ''}}">
    <label for="user_role_id" class="control-label">{{ 'User Role Id' }}</label>
    <input class="form-control" name="user_role_id" type="number" id="user_role_id" value="{{ isset($user->user_role_id) ? $user->user_role_id : ''}}" >
